...
def populate_main_window(frm_main):
    ...
    lbl_circle_area = Label(frm_main, width=3)
    ...
    lbl_circle_area.grid(     row=1, column=0, padx=(30,3), pady=3)
    lbl_circle_area.grid(row=1, column=3, padx=0, pady=3)
    ...
    def calculate(event):
        ...
        try:
            ...
            lbl_circle_area.config(text=f"{circle_area:.2f}")
